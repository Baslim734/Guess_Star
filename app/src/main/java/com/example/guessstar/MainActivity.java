...
public class MainActivity extends AppCompatActivity {
    ...
    private void getContent(){
        ...
        try {
            ...
            String start = "<div class=\"methodology_show\">Методология</div>-->";
  ...
  //          Log.i("myresult",splitContent);
    ...
    public void onClickAnswer(View view) {
        ...
        if(Integer.parseInt(tag)==numberOfRightAnswer){
            ...
            Toast.makeText(this, "Not right! Right answer is: " + names.get(numberOfQuestion), Toast.LENGTH_SHORT).show();
        }
        playGame();
    }
